...
(function () {
  ...
  wrapper.innerHTML = [
    ...
    '<aside class="support-widget" role="dialog" aria-modal="false" aria-labelledby="support-widget-title" aria-hidden="true">',
      '<header class="support-widget__hero">',
        '<img class="support-widget__brand" src="assets/logo-192.webp" width="52" height="52" alt="NutriMama">',
        ...
        '<p class="support-widget__subtitle">Consulte respostas rápidas ou escreva para a equipe NutriMama.</p>',
      '</header>',
      '<div class="support-widget__body">',
        '<div class="support-widget__view" data-support-view="home">',
          ...
          '<a class="support-widget__card" href="https://app.nutrimae.app/app/suporte">',
            ...
            '<span class="support-widget__card-copy"><span class="support-widget__card-title">Já tenho acesso ao NutriMama</span><span class="support-widget__card-text">Abra a central de suporte do app e acompanhe suas mensagens.</span></span>',
            '<span class="support-widget__card-arrow" aria-hidden="true">›</span>',
          '</a>',
  ...
  form.addEventListener('submit', function (event) {
    ...
    var subject = 'Suporte NutriMama — mensagem de ' + name;
