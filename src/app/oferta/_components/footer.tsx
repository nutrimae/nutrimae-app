  ...
  return (
    <footer className="bg-cream-deep px-5 py-8 text-center text-xs text-brown-700/70">
      <div className="mx-auto flex w-full max-w-sm flex-col gap-2">
        <p>NutriMama · CNPJ 68.580.891/0001-36</p>
        <p>© {new Date().getFullYear()} NutriMama. Todos os direitos reservados.</p>
        ...
        <p className="mt-2 text-[11px] text-brown-700/60">
          O NutriMama é uma ferramenta de organização e planejamento da rotina alimentar. Não substitui orientação
